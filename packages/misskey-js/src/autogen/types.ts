...
export type components = {
  schemas: {
    ...
    Notification: {
      ...
      createdAt: string;
      /** @enum {string} */
      type: 'note' | 'follow' | 'mention' | 'reply' | 'renote' | 'quote' | 'reaction' | 'pollEnded' | 'receiveFollowRequest' | 'followRequestAccepted' | 'roleAssigned' | 'app' | 'test' | 'reaction:grouped' | 'renote:grouped';
