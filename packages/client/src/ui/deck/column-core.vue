...
<XFavoritesColumn v-else-if="column.type === 'favorites'" :column="column" :is-stacked="isStacked" @parent-focus="emit('parent-focus', $event)"/>
...
import XFavoritesColumn from './favorites-column.vue';
