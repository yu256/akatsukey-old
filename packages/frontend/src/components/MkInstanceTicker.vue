...
instance.themeColor ??= '#777777';

const tickerColor = {
	'--ticker-bg': instance.themeColor,
	'--ticker-fg': getTickerFgColor(instance.themeColor),
	'--ticker-bg-rgb': (({ r, g, b }): string => `${r}, ${g}, ${b}`)(hexToRgb(instance.themeColor)),
};
</script>
...
.leftedge {
	...
	height: 100%;
	border-radius: 0;
	background: rgba(var(--ticker-bg-rgb), 0.2);
	> .icon {
		display: block;
		width: 100%;
	}
